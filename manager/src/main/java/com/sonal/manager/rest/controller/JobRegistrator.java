...
public class JobRegistrator {
	...
	@PostMapping(value="/submitJob",consumes= MediaType.APPLICATION_JSON_VALUE,produces=MediaType.APPLICATION_JSON_VALUE)
	public Mono<ResponseEntity<JobResponseVO>> submitJob(@RequestBody JobRequestVO jobRequestVO){
		
		return jobProcessor.process(jobRequestVO)
